...
const Header = () => {  
    ...
    return (
        <header className='flex justify-between items-center py-4 px-8 bg-linear-65 from-[#1a1a1a] to-[#e6e6e6]'>
            ...
            {/*SEARCH*/}
            <div className='flex items-center gap-4 bg-gray-300 text-black rounded-[20px] px-5 py-2 w-[500px] shadow-xl'>
